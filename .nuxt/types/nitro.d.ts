...
declare module 'nitropack' {
  ...
  interface InternalApi {
    '/api/players': Awaited<ReturnType<typeof import('../../server/api/players/index').default>>
    '/api/players/:player': Awaited<ReturnType<typeof import('../../server/api/players/[player]').default>>
    '/api/leagues': Awaited<ReturnType<typeof import('../../server/api/leagues/index').default>>
    '/api/fixtures': Awaited<ReturnType<typeof import('../../server/api/fixtures/index').default>>
    '/api/fixtures/:fixture/statistics': Awaited<ReturnType<typeof import('../../server/api/fixtures/[fixture]/statistics').default>>
    '/api/fixtures/:fixture': Awaited<ReturnType<typeof import('../../server/api/fixtures/[fixture]/index').default>>
...
declare global {
  ...
  const cachedEventHandler: typeof import('/workspaces/GreatUniHack-2022/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('/workspaces/GreatUniHack-2022/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('/workspaces/GreatUniHack-2022/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('/workspaces/GreatUniHack-2022/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('/workspaces/GreatUniHack-2022/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('/workspaces/GreatUniHack-2022/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('/workspaces/GreatUniHack-2022/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('/workspaces/GreatUniHack-2022/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('/workspaces/GreatUniHack-2022/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useQuery: typeof import('h3')['useQuery']
  const useRawBody: typeof import('h3')['useRawBody']
  const useRuntimeConfig: typeof import('/workspaces/GreatUniHack-2022/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useStorage: typeof import('/workspaces/GreatUniHack-2022/node_modules/nitropack/dist/runtime')['useStorage']
