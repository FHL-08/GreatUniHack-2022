globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///workspaces/GreatUniHack-2022/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'http';
import { tmpdir } from 'os';
import { join } from 'path';
import fs, { mkdirSync } from 'fs';
import { parentPort, threadId } from 'worker_threads';
import { provider, isWindows } from 'file:///workspaces/GreatUniHack-2022/node_modules/std-env/dist/index.mjs';
import { eventHandler, setHeaders, sendRedirect, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, lazyEventHandler, toNodeListener, getQuery, createError } from 'file:///workspaces/GreatUniHack-2022/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///workspaces/GreatUniHack-2022/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///workspaces/GreatUniHack-2022/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///workspaces/GreatUniHack-2022/node_modules/vue/server-renderer/index.mjs';
import { parseURL, withQuery, joinURL } from 'file:///workspaces/GreatUniHack-2022/node_modules/ufo/dist/index.mjs';
import destr from 'file:///workspaces/GreatUniHack-2022/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file:///workspaces/GreatUniHack-2022/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///workspaces/GreatUniHack-2022/node_modules/ohmyfetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///workspaces/GreatUniHack-2022/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///workspaces/GreatUniHack-2022/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///workspaces/GreatUniHack-2022/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file:///workspaces/GreatUniHack-2022/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///workspaces/GreatUniHack-2022/node_modules/unstorage/dist/drivers/fs.mjs';
import defu from 'file:///workspaces/GreatUniHack-2022/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file:///workspaces/GreatUniHack-2022/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/workspaces/GreatUniHack-2022/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"/workspaces/GreatUniHack-2022","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"/workspaces/GreatUniHack-2022/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"/workspaces/GreatUniHack-2022/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/workspaces/GreatUniHack-2022/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const errorHandler = (async function errorhandler(error, event) {
  ...
  if (!res) {
    const { template } = await import('file:///workspaces/GreatUniHack-2022/node_modules/@nuxt/ui-templates/dist/templates/error-dev.mjs') ;
    {
...
const getClientManifest = () => import('/workspaces/GreatUniHack-2022/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('/workspaces/GreatUniHack-2022/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
